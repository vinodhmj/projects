...
1. PSS increases the damping torque and hence the damping of the system
2. It reduces the synchronising torque
3. System bandwidth will also be brought down
...
1. Higher the initial loading, unstable the system gets
2. The starting rotor angle position is very high 
