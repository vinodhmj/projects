...
#+caption: Security Constrained OPF
#+name:scopf
#+ATTR_LATEX: :placement [H] :center t :align |r|c|c|c|c|
|--------+------------+--------------+------------------+-------------|
|        |       Wind |  Hourly Cost | Wind Curtailment | Curtailment |
|        | generation | (\pounds/hr) | SCOPF            | OPF         |
|--------+------------+--------------+------------------+-------------|
| Summer |         0% |        23999 | 0/300            |             |
|        |       100% |        22307 | 240/300          |             |
|--------+------------+--------------+------------------+-------------|
...
\begin{figure}[H]
    \centering
    \subfloat[\centering Summer]{{\includegraphics[width=7cm]{screens/3SummerScopf.PNG} }}%
    \qquad
    \subfloat[\centering Winter]{{\includegraphics[width=7cm]{screens/3WinterScopf.PNG} }}%
    \caption{SCOPF and Renewables}%
    \label{fig:3scopf}%
\end{figure}
#+END_SRC
** Observations
Discuss and explain the main differences in results you see between the OPF
...
experimented. Following are the observations:
